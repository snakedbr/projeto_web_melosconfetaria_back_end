...
public class TokenUtil {
	...
	private static final String SECRET_KEY = "b6ddbbd8d65d31200f40190bf91f4b82b6ddbbd8d65d31200f40190bf91f4b82";
	...
	public static String createToken(Usuario usuario) {
		...
		String token = Jwts.builder().setSubject(usuario.getLogin()).setIssuer(EMISSOR)
